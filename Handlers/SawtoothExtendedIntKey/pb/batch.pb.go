...
func (x *GroupEnvelop) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupEnvelop) ProtoMessage() {}

func (x *GroupEnvelop) ProtoReflect() protoreflect.Message {
	mi := &file_batch_proto_msgTypes[0]
...
// Deprecated: Use GroupEnvelop.ProtoReflect.Descriptor instead.
func (*GroupEnvelop) Descriptor() ([]byte, []int) {
	return file_batch_proto_rawDescGZIP(), []int{0}
}

func (x *GroupEnvelop) GetPublicKey() []byte {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (x *GroupEnvelop) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *GroupEnvelop) GetScheme() string {
	if x != nil {
		return x.Scheme
	}
	return ""
...
type BatchHeader struct {
	...
	// Group Envelop
	GroupEnvelop []byte `protobuf:"bytes,3,opt,name=group_envelop,json=groupEnvelop,proto3" json:"group_envelop,omitempty"`
}
...
func (x *BatchHeader) GetGroupEnvelop() []byte {
	if x != nil {
		return x.GroupEnvelop
	}
	return nil
}
...
var file_batch_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x63, 0x0a, 0x0c, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x45, 0x6e, 0x76,
	...
	0x09, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x65, 0x22, 0x87, 0x01, 0x0a, 0x0b, 0x42, 0x61,
	0x74, 0x63, 0x68, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x2a, 0x0a, 0x11, 0x73, 0x69, 0x67,
	...
	0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e,
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x73, 0x12, 0x23,
	0x0a, 0x0d, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x65, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x45, 0x6e, 0x76, 0x65,
	0x6c, 0x6f, 0x70, 0x22, 0x95, 0x01, 0x0a, 0x05, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x16, 0x0a,
	...
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0c, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x72, 0x61, 0x63, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x74, 0x72, 0x61, 0x63, 0x65, 0x22, 0x30, 0x0a, 0x09, 0x42,
	0x61, 0x74, 0x63, 0x68, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x07, 0x62, 0x61, 0x74, 0x63,
	0x68, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x42,
	0x61, 0x74, 0x63, 0x68, 0x52, 0x07, 0x62, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x62, 0x06, 0x70,
...
var file_batch_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_batch_proto_goTypes = []interface{}{
	(*GroupEnvelop)(nil), // 0: pb.GroupEnvelop
	(*BatchHeader)(nil),  // 1: pb.BatchHeader
	(*Batch)(nil),        // 2: pb.Batch
	(*BatchList)(nil),    // 3: pb.BatchList
	(*Transaction)(nil),  // 4: pb.Transaction
}
var file_batch_proto_depIdxs = []int32{
	4, // 0: pb.Batch.transactions:type_name -> pb.Transaction
	2, // 1: pb.BatchList.batches:type_name -> pb.Batch
